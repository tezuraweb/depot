            ...
            <div className="gallery__frame flex">
                ...
                <div className="flex flex--col">
                    <div className="gallery__controls">
                        <button className="gallery__controls--button" onClick={handlePrevious} disabled={!canNavigate.prev}>
                        <IconSprite
                                    selector="PrevIcon"
                                    width="40"
                                    height="40"
                        ...
                        <button className="gallery__controls--button" onClick={handleNext} disabled={!canNavigate.next}>
                        <IconSprite
                                    selector="NextIcon"
                                    width="40"
                                    height="40"
